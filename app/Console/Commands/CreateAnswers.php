...
class CreateAnswers extends Command
{
    ...
    public function handle()
    {
        ...
        $data = [
            ...
            ['level' => 3, 'description' => '文法知識はある', 'category_id' => 1,  'created_at' => $now, 'updated_at' => $now],
            ['level' => 4, 'description' => '独力でのアプリケーション作成経験あり', 'category_id' => 1,  'created_at' => $now, 'updated_at' => $now],
