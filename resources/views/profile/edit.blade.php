...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">プロファイル編集</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="/profile" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nickname" placeholder="システム内で識別に使用される名前" class="col-md-8" value="{{ $profile->nickname }}">
                            </div>
                            <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="skillLevel[{{ $skill->id }}]" id="skill-{{ $skill->id }}">
                                                            @foreach($category->answers as $index => $answer)
                                                                @if($answer->level == $profile->skills->where('id', $skill->id)->first()->skillLevel->level)
